...
resource "aws_internet_gateway" "this_gateway" {
  ...
  tags = {
    Name = "${var.name}_${var.env}_internet_gateway"
    Terraform = true
    Project = var.name
    Enviroment = var.env
  }
...
resource "aws_subnet" "this_public_subnet" {
  ...
  tags = {
    Name = "${var.name}_${var.env}_public_${var.availability_zones[count.index]}"
    Terraform = true
    Project = var.name
    Enviroment = var.env
  }
...
resource "aws_nat_gateway" "this_nat" {
  ...
  tags = {
    Name = "${var.name}_${var.env}_nat_${var.availability_zones[count.index]}"
    Terraform = true
    Project = var.name
    Enviroment = var.env
  }
...
resource "aws_subnet" "this_private_subnet" {
  ...
  tags = {
    Name = "${var.name}_${var.env}_private_${var.availability_zones[count.index]}"
    Terraform = true
    Project = var.name
    Enviroment = var.env
  }
...
resource "aws_route_table" "route" {
  ...
  tags = {
    Name = "${var.name}_${var.env}_public_route_table"
    Terraform = true
    Project = var.name
    Enviroment = var.env
  }
...
resource "aws_route_table" "private_route" {
  ...
  tags = {
    Name = "${var.name}_${var.env}_private_route_table_${var.availability_zones[count.index]}"
    Terraform = true
    Project = var.name
    Enviroment = var.env
  }
